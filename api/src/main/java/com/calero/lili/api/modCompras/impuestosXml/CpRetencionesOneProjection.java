package com.calero.lili.api.modCompras.impuestosXml;
...
public interface CpRetencionesOneProjection {
    ...
    UUID getIdRetencion();
    void setIdRetencion(UUID idRetencion);

    UUID getIdTercero();
    void setIdCliente(UUID idTercero);
