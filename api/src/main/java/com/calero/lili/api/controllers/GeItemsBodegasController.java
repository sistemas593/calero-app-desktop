...
public class GeItemsBodegasController {
    ...
    public PaginatedDto<GeItemBodegaReportDto> findAllPaginate(@PathVariable("idEmpresa") Long idEmpresa,
        ...
        Sort sort = pageable.getSort().and(Sort.by("idBodega").ascending());
        ...
        return geItemsMedidasService.findAllPaginate(idDataService.getIdData(), idEmpresa, filters, pageableConSort);
    }
