...
import com.calero.lili.core.modComprasItemsGrupos.GeItemsGruposServiceImpl;
import com.calero.lili.core.modComprasItemsGrupos.dto.GeItemGrupoCreationRequestDto;
import com.calero.lili.core.modComprasItemsGrupos.dto.GeItemGrupoGetListDto;
import com.calero.lili.core.modComprasItemsGrupos.dto.GeItemGrupoGetOneDto;
import com.calero.lili.core.modComprasItemsGrupos.dto.GeItemGrupoListFilterDto;
...
public class GeItemsGruposController {
    ...
    public PaginatedDto<GeItemGrupoGetListDto> findAllPaginate(@PathVariable("idEmpresa") Long idEmpresa,
        ...
        return geItemsGruposService.findAllPaginate(idDataService.getIdData(), idEmpresa, filters, pageableConSort);
    }
