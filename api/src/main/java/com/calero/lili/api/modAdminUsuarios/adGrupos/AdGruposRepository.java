...
public interface AdGruposRepository extends JpaRepository<AdGruposEntity, Long> {
    ...
    @Query("select u from AdGruposEntity u where u.idGrupo =:idGrupo ")
    Optional<AdGruposEntity> getFindId(@Param("idGrupo") Long idGrupo);
    ...
    Page<AdGruposEntity> findAllPaginate(@Param("filter") String filter, Pageable pageable);
