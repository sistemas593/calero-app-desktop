...
public class VentasRetencionesController {
    ...
    public PaginatedDto<GetVentaRetencionesListDto> findAllPaginate(@PathVariable("idEmpresa") Long idEmpresa,
        ...
        Sort sort = pageable.getSort().and(Sort.by("idRetencion").ascending());
    ...
    public void exportarExcel(HttpServletResponse response,
                              ...
                              FilterListVentasRetencionesDto filter) throws IOException {
    ...
    public void exportarPDF(HttpServletResponse response,
                            @PathVariable("idEmpresa") Long idEmpresa,
                            FilterListVentasRetencionesDto filters) throws DocumentException, IOException {
