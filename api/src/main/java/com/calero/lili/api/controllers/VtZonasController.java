...
import com.calero.lili.core.modVentasZonas.VtZonasServiceImpl;
...
public class VtZonasController {
    ...
    public PaginatedDto<VtZonaGetListDto> findAllPaginate(@PathVariable("idEmpresa") Long idEmpresa,
                                                          FilterDto filters,
                                                          Pageable pageable) {
        Sort sort = pageable.getSort().and(Sort.by("idZona").ascending());
        ...
        return vtZonasService.findAllPaginate(idDataService.getIdData(), idEmpresa, filters, pageableConSort);
    }
