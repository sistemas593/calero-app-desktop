...
import com.calero.lili.core.modComprasItemsMarcas.GeItemsMarcasServiceImpl;
import com.calero.lili.core.modComprasItemsMarcas.dto.GeItemMarcasReportDto;
import com.calero.lili.core.modComprasItemsMarcas.dto.GeItemMedidaCreationResponseDto;
import com.calero.lili.core.modComprasItemsMarcas.dto.GeItemMedidaListFilterDto;
import com.calero.lili.core.modComprasItemsMarcas.dto.GeItemsMarcasCreationRequestDto;
...
public class GeItemsMarcasController {
    ...
    public PaginatedDto<GeItemMarcasReportDto> findAllPaginate(GeItemMedidaListFilterDto filters,
        ...
        Sort sort = pageable.getSort().and(Sort.by("idMarca").ascending());
