...
public interface TbRetencionesCodigosRepository extends JpaRepository<TbRetencionesCodigosEntity, String> {
    ...
    Optional<TbRetencionesCodigosEntity> findById(String codigoDocumento);
    ...
    Page<TbRetencionesCodigosEntity> findAllPaginate(String filter, String filterContent, Pageable pageable);
}
