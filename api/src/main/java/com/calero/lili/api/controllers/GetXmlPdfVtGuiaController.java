...
public class GetXmlPdfVtGuiaController {
    ...
    public ResponseEntity<byte[]> descargarPdfFactura(@PathVariable("idEmpresa") Long idEmpresa,
        ...
        ArchivoDto datos = vtVentasService.findPDFGuiaById(idDataService.getIdData(), idEmpresa, idRecibida, "WEB");
    ...
    public ResponseEntity<byte[]> descargarXmlFactura(@PathVariable("idEmpresa") Long idEmpresa,
        ...
        ArchivoDto datos = vtVentasService.findFileXMLGuia(idDataService.getIdData(), idEmpresa, idRecibida);
