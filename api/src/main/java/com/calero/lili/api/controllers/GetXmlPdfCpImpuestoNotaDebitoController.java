...
public class GetXmlPdfCpImpuestoNotaDebitoController {
    ...
    public ResponseEntity<byte[]> descargarPdfNotaDebito(@PathVariable("idEmpresa") Long idEmpresa,
        ...
        ArchivoDto datos = vtVentasService.findPDFNotaDebitoById(idDataService.getIdData(), idEmpresa, idRecibida, "LOC"); // tu byte[]
