package com.calero.lili.api.comprobantes.objetosXml.liquidacionCompras;
...
@XmlType(propOrder = {"infoTributaria", "infoLiquidacionCompra", "detalle", "reembolsoDetalle", "campoAdicional"})
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
...
public class LiquidacionCompra {
    ...
    public static void main(String args[]) {
        ...
        //////////////////////////////////////////
        LiquidacionCompra f1 = new LiquidacionCompra();
        //////////////////////////////////////////
        ...
        //////////////////////////////////////////
        InfoLiquidacionCompra If1 = new InfoLiquidacionCompra();
        ...
        If1.setTipoIdentificacionProveedor("06");
        If1.setRazonSocialProveedor("001p");
        If1.setIdentificacionProveedor("PAYPAL");
      ...
      //  If1.setTotalImpuesto(listaTotalImpuesto);
        f1.setInfoLiquidacionCompra(If1);
       ...
       // If1.setTotalImpuesto(listaTotalImpuesto);
        ...
        Reemb1.setIdentificacionProveedorReembolso("1212121212001");
        ...
        Reemb1.setSecuencialDocReembolso("000000067");
        Reemb1.setFechaEmisionDocReembolso("22/02/2023");
        Reemb1.setNumeroautorizacionDocReemb("6767676767");

        DetalleImpuesto ReemDetImp1 = new DetalleImpuesto();
        ReemDetImp1.setCodigo("04");
        ReemDetImp1.setCodigoPorcentaje("8");
        ReemDetImp1.setTarifa("8");
        ReemDetImp1.setBaseImponibleReembolso("1.00");
        ReemDetImp1.setImpuestoReembolso("0.08");

        List<DetalleImpuesto> listaReembolsoDetalleImpuesto = new ArrayList<DetalleImpuesto>();
        listaReembolsoDetalleImpuesto.add(ReemDetImp1);
        Reemb1.setDetalleImpuesto(listaReembolsoDetalleImpuesto);
        ...
        try {
            JAXBContext context = JAXBContext.newInstance(
                    new Class[]{LiquidacionCompra.class});
            Marshaller marshaller = context.createMarshaller();
            marshaller.setProperty("jaxb.encoding", "UTF-8");
            marshaller.setProperty("jaxb.formatted.output",
                    Boolean.valueOf(true));
            out = new OutputStreamWriter(new FileOutputStream(
                    "liquidacion.xml"), "UTF-8");
