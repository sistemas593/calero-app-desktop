...
import com.calero.lili.core.modComprasItemsCategorias.GeItemsCategoriaServiceImpl;
...
public class GeItemsCategoriaController {
    ...
    public PaginatedDto<GeItemCategoriaReportDto> findAllPaginate(GeItemMedidaListFilterDto filters,
        ...
        Sort sort = pageable.getSort().and(Sort.by("idCategoria").ascending());
        ...
        return geItemsCategoriaService.findAllPaginate(idDataService.getIdData(), filters, pageableConSort);
    }
