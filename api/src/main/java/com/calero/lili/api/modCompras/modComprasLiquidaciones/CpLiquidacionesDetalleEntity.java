...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "cpLiquidacionesDetalle")
@Builder
public class CpLiquidacionesDetalleEntity {

    @Id
    @Column(unique = true, updatable = false, nullable = false)
    private UUID idLiquidacionDetalle;
    ...
    // aqui va precio * cantidad - descuento
...
//    private VtGuiaEntity detalles; // NOMBRE DE LA RELACION, ESTE VA EN LA TABLA PRINCIPAL
