...
public interface GeTercerosRepository extends JpaRepository<GeTerceroEntity, UUID> {
    ...
    void deleteByIdCliente(Long idData, UUID idTercero);

    @Query(value = "SELECT entity " +
            "FROM GeTerceroEntity entity " +
            "where entity.idData = :idData and " +
            "entity.idTercero = :idTercero")
    Optional<GeTerceroEntity> findByIdCliente(Long idData, UUID idTercero);
    ...
    Optional<GeTerceroProjection> findExistByNumeroIdentificacion(Long idData, String numeroIdentificacion);
    ...
    Optional<GeTerceroEntity> getFindExistByNumeroIdentificacion(Long idData, String numeroIdentificacion);
