...
import com.calero.lili.core.modTesoreria.TsComprabanteEgreso.TsComprobanteEgresoServiceImpl;
...
public class TsComprobanteEgresoController {
    ...
    public ResponseDto create(@PathVariable("idEmpresa") Long idEmpresa,
        ...
        return tsComprobanteEgresoService.create(idDataService.getIdData(), idEmpresa, UUID.randomUUID(), request, auditorAware.getCurrentAuditor().orElse("SYSTEM"));
    }
    ...
    public ResponseDto update(@PathVariable("idEmpresa") Long idEmpresa,
        ...
        return tsComprobanteEgresoService.update(idDataService.getIdData(), idEmpresa, idComprobante, request, auditorAware.getCurrentAuditor().orElse("SYSTEM"));
    }
    ...
    public void delete(@PathVariable("idEmpresa") Long idEmpresa,
                       @PathVariable("idComprobante") UUID idComprobante) {
        tsComprobanteEgresoService.delete(idDataService.getIdData(), idEmpresa, idComprobante, auditorAware.getCurrentAuditor().orElse("SYSTEM"));
    }
