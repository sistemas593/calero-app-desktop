...
public class LiquidacionCompraPdf {
     ...
     * anidada que va adentro. Se usa en los dos cuadros del encabezado (RUC/LIQUIDACIÓN
     * DE COMPRA y datos de empresa) para que, sin importar cuál de los dos tenga más
