...
import com.calero.lili.core.modVentasPedidos.dto.FilterListDto;
...
public class PedidosServiceImpl {
    ...
    private Page<VtPedidoEntity> getTipoBusquedaPaginado(Long idData, Long idEmpresa, FilterListDto filters,
