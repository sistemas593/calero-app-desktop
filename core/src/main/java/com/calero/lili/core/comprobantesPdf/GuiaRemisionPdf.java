...
public class GuiaRemisionPdf {
     ...
     * anidada que va adentro. Se usa en los dos cuadros del encabezado (RUC/GUIA DE
     * REMISIÓN y datos de empresa) para que, sin importar cuál de los dos tenga más
