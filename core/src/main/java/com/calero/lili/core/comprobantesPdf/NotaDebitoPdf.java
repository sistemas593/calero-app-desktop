...
public class NotaDebitoPdf {
    ...
    public byte[] generarPdf(NotaDebito factura, String AutorizacionSRI, String fechaAutorizacion, byte[] imageBytes) {
        ...
        try {
            ...
            celda = generateCell(new Paragraph("NOTA DE DÉBITO", bigFont), LEFT_PADDING_DOCUMENTO);
            celda.setColspan(2);
            table_datos_documento.addCell(celda);
            ...
            cell = generateCell(new Paragraph(factura.getInfoNotaDebito().getDirEstablecimiento(), fuente), LEFT_PADDING_EMPRESA);
            cell.setColspan(4);
            ...
            cell = generateCell(new Paragraph(factura.getInfoNotaDebito().getContribuyenteEspecial(), fuente), LEFT_PADDING_EMPRESA);
            cell.setColspan(2);
            cell.setPaddingTop(20);
            table_datos_empresa.addCell(cell);
            ...
            cell = generateCell(new Paragraph(factura.getInfoNotaDebito().getObligadoContabilidad(), fuente), LEFT_PADDING_EMPRESA);
            cell.setColspan(1);
            cell.setPaddingTop(15);
            cell.setPaddingBottom(5); // estaba 15 para no dejar linea
            table_datos_empresa.addCell(cell);
            ...
            cell = generateCell(new Paragraph(factura.getInfoNotaDebito().getRazonSocialComprador(), fuente), PADDING_NONE);
            cell.setColspan(4);
            cell.setPaddingBottom(5);
            ...
            cell = generateCell(new Paragraph(factura.getInfoNotaDebito().getFechaEmision(), fuente), PADDING_NONE);
            cell.setColspan(1);
            cell.setPaddingBottom(15);
            cell.setPaddingLeft(-20);
            table_datos.addCell(cell);
            ...
            cell = generateCell(new Paragraph(factura.getInfoNotaDebito().getIdentificacionComprador(), fuente), PADDING_NONE);
            cell.setColspan(3);
            cell.setPaddingBottom(5);
            cell.setPaddingLeft(-20);
            table_datos.addCell(cell);

            cell = generateCell(new Paragraph(" Comprobante que se modifica:", title), LEFT_PADDING_EMPRESA);
            cell.setPaddingBottom(5);
            cell.setColspan(2);
            ...
            cell = generateCell(new Paragraph(" Fecha Emisión (Comprobante a modificar):", title), LEFT_PADDING_EMPRESA);
            cell.setPaddingBottom(3);
            cell.setColspan(2);
            cell.setPaddingLeft(7);
            table_datos.addCell(cell);

            cell = generateCell(new Paragraph(factura.getInfoNotaDebito().getFechaEmisionDocSustento(), fuente), PADDING_NONE);
            cell.setColspan(5);
            ...
            PdfPTable table_detalle = new PdfPTable(3);
            table_detalle.setWidthPercentage(100);
            table_detalle.setTableEvent(new BorderEventWithoutRadius());

            cell = new PdfPCell(new Phrase("RAZÓN DE LA MODIFICACIÓN", title));
            cell.setColspan(2);
            cell.setPaddingBottom(10);
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            table_detalle.addCell(cell);

            cell = new PdfPCell(new Phrase("VALOR DE LA MODIFICACIÓN", title));
            cell.setColspan(1);
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            table_detalle.addCell(cell);

            List<Motivo> lista1 = factura.getMotivo();
            for (Motivo det : lista1) {

                cell = new PdfPCell(new Phrase(det.getRazon(), fuente));
                cell.setColspan(2);
                cell.setPaddingBottom(5);
                table_detalle.addCell(cell);

                cell = new PdfPCell(new Phrase(det.getValor().toUpperCase(), fuente));
                cell.setColspan(1);
...
//            tableIntermedia.addCell(cell);
            ...
            if (totalImpuestos != null && !totalImpuestos.isEmpty()) {
                ...
                subTotal8 = totalImpuestos.stream()
            ...
            if (Objects.nonNull(subTotal8)) {
                ...
                cell = new PdfPCell(new Phrase(subTotal8.getBaseImponible(), fuente));
                cell.setColspan(2);
                cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
                table_totales.addCell(cell);
                ...
                cell = new PdfPCell(new Phrase(subTotal8.getValor(), fuente));
                cell.setColspan(2);
                cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
                table_totales.addCell(cell);
            }
            ...
            cell.setColspan(2);
            table_totales.addCell(cell);
            cell = new PdfPCell(new Phrase(factura.getInfoNotaDebito().getValorTotal(), fuente));
            cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
            table_totales.addCell(cell);
     ...
     * anidada que va adentro. Se usa en los dos cuadros del encabezado (RUC/NOTA DE
     * DÉBITO y datos de empresa) para que, sin importar cuál de los dos tenga más
     * contenido, ambos terminen exactamente a la misma altura abajo: como los dos
