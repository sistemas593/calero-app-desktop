...
import com.calero.lili.core.modClientesTickets.builder.ClienteTicketsBuilder;
...
public class VtClientesTicketsServiceImpl {
    ...
    public ResponseDto create(Long idData, VtClientesTicketsCreationRequestDto request, String usuario) {

        VtClienteTicketsEntity entidad = clienteTicketsBuilder.builderEntity(request, idData);
        entidad.setCreatedBy(usuario);
        entidad.setCreatedDate(LocalDateTime.now());
        vtClientesTicketsRepository.save(entidad);
        return responseApiBuilder.builderResponse(entidad.getIdTicket().toString());

    }

    public ResponseDto update(Long idData, UUID id, VtClientesTicketsCreationRequestDto request, String usuario) {
