package com.calero.lili.core.modVentas.reembolsos.projection;

import java.math.BigDecimal;
import java.time.LocalDate;
import java.util.UUID;

public interface VtVentasReembolsoProjection {
    ...
    UUID getIdVentaReembolso();

    void setIdVentaReembolso(UUID idLiquidacion);
