...
public class VtVentasFacturasServiceImpl {
    ...
    private List<Integer> getTarifaValoresInteger(List<ValoresDto> valores) {
    ...
    private void validarTotalPagoSri(CreationFacturaRequestDto request) {
    ...
    private GeTerceroEntity validacionTercero(Long idData, CreationFacturaRequestDto request) {
        ...
        if (Objects.nonNull(request.getIdTercero())) {
            ...
            if (Objects.isNull(request.getSecuencial()) || request.getSecuencial().isEmpty()) {
                throw new GeneralException("Es requerido el secuencial para el documento");
            }
