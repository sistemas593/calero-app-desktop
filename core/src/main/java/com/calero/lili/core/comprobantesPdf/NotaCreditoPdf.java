...
public class NotaCreditoPdf {
    ...
    public byte[] generarPdf(NotaCredito factura, String AutorizacionSRI, String fechaAutorizacion, byte[] imageBytes) {
        ...
        try {
            ...
            celda = generateCell(new Paragraph("NOTA DE CRÉDITO", bigFont), LEFT_PADDING_DOCUMENTO);
            celda.setColspan(2);
            table_datos_documento.addCell(celda);
            ...
            cell = generateCell(new Paragraph(factura.getInfoNotaCredito().getDirEstablecimiento(), fuente), LEFT_PADDING_EMPRESA);
            cell.setColspan(4);
            ...
            cell = generateCell(new Paragraph(factura.getInfoNotaCredito().getContribuyenteEspecial(), fuente), LEFT_PADDING_EMPRESA);
            cell.setColspan(2);
            cell.setPaddingTop(20);
            table_datos_empresa.addCell(cell);
            ...
            cell = generateCell(new Paragraph(factura.getInfoNotaCredito().getObligadoContabilidad(), fuente), LEFT_PADDING_EMPRESA);
            cell.setColspan(1);
            cell.setPaddingTop(15);
            cell.setPaddingBottom(5); // estaba 15 para no dejar linea
            table_datos_empresa.addCell(cell);
            ...
            cell = generateCell(new Paragraph(factura.getInfoNotaCredito().getRazonSocialComprador(), fuente), PADDING_NONE);
            cell.setColspan(5);
            cell.setPaddingBottom(5);
 ...
 */
            ...
            cell = generateCell(new Paragraph(factura.getInfoNotaCredito().getFechaEmision(), fuente), PADDING_NONE);
            cell.setColspan(1);
            cell.setPaddingBottom(5);
            ...
            cell = generateCell(new Paragraph(factura.getInfoNotaCredito().getIdentificacionComprador(), fuente), PADDING_NONE);
            cell.setColspan(1);
            cell.setPaddingBottom(5);
            cell.setPaddingLeft(-20);
            table_datos.addCell(cell);

            cell = generateCell(new Paragraph("", title), LEFT_PADDING_EMPRESA);
            cell.setColspan(1);
            cell.setPaddingBottom(15);
            table_datos.addCell(cell);
            ...
            cell = generateCell(new Paragraph(factura.getInfoNotaCredito().getFechaEmisionDocSustento(), fuente), PADDING_NONE);
            cell.setColspan(5);
            cell.setPaddingBottom(3);
            cell.setPaddingLeft(5);
            table_datos.addCell(cell);

            cell = generateCell(new Paragraph(" Razón de Modificación:", title), LEFT_PADDING_EMPRESA);
            cell.setPaddingBottom(5);
            cell.setColspan(2);
            cell.setPaddingLeft(7);
            table_datos.addCell(cell);

            cell = generateCell(new Paragraph(factura.getInfoNotaCredito().getMotivo(), fuente), PADDING_NONE);
            cell.setColspan(5);
            cell.setPaddingBottom(5);
            cell.setPaddingLeft(5);
            table_datos.addCell(cell);
            ...
            for (Detalle det : lista1) {
                ...
                cell = new PdfPCell(new Phrase(det.getCodigoInterno(), fuente));
                cell.setPaddingBottom(5);
                table_detalle.addCell(cell);
...
//            }
            ...
            table_pagos.setTableEvent(new NotaCreditoPdf.BorderEventWithoutRadius());
...
//            table_totales.addCell(cell);
            ...
            cell.setColspan(2);
            table_totales.addCell(cell);
            cell = new PdfPCell(new Phrase(infoFactura.getValorModificacion(), fuente));
            cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
            table_totales.addCell(cell);
     ...
     * CRÉDITO y datos de empresa) para que, sin importar cuál de los dos tenga más
