...
public class VtNotaCreditoDetalleBuilder {
    ...
    public List<VtVentaDetalleEntity> builderList(List<DetallesDto> list, Long idData, Long idEmpresa) {
        return list.stream()
                .map(x -> builderDetalle(x, idData, idEmpresa))
                .toList();
    }

    private VtVentaDetalleEntity builderDetalle(DetallesDto model, Long idData, Long idEmpresa) {
    ...
    private List<VtVentaDetalleEntity.DetalleAdicional> builderListDetalleAddicional(List<DetallesDto.DetalleAdicional> list) {
    ...
    private VtVentaDetalleEntity.DetalleAdicional builderDetalle(DetallesDto.DetalleAdicional model) {
