...
public class ComprobanteRetencionPdf {
    ...
    public byte[] generarPdf(ComprobanteRetencion factura, String AutorizacionSRI, String fechaAutorizacion, byte[] imageBytes) {
        ...
        try {
            ...
            celda = generateCell(new Paragraph("COMPROBANTE DE RETENCIÓN", bigFont), LEFT_PADDING_DOCUMENTO);
            celda.setColspan(2);
            table_datos_documento.addCell(celda);
            ...
            cell = generateCell(new Paragraph(factura.getInfoCompRetencion().getDirEstablecimiento(), fuente), LEFT_PADDING_EMPRESA);
            cell.setColspan(4);
            ...
            cell = generateCell(new Paragraph(factura.getInfoCompRetencion().getContribuyenteEspecial(), fuente), LEFT_PADDING_EMPRESA);
            cell.setColspan(2);
            cell.setPaddingTop(20);
            table_datos_empresa.addCell(cell);
            ...
            cell = generateCell(new Paragraph(factura.getInfoCompRetencion().getObligadoContabilidad(), fuente), LEFT_PADDING_EMPRESA);
            cell.setColspan(1);
            cell.setPaddingTop(15);
            cell.setPaddingBottom(5); // estaba 15 para no dejar linea
            table_datos_empresa.addCell(cell);
            ...
            //////////////////////////////
            // TABLA 2 iNFO COMPROBANTE DE RETENCION
            ...
            cell = generateCell(new Paragraph("Razón Social:", title), LEFT_PADDING_EMPRESA);
            cell.setPaddingBottom(5);
            cell.setColspan(1);
            table_datos.addCell(cell);

            cell = generateCell(new Paragraph(factura.getInfoCompRetencion().getRazonSocialSujetoRetenido(), fuente), PADDING_NONE);
            cell.setColspan(5);
            cell.setPaddingBottom(5);
            ...
            cell = generateCell(new Paragraph(factura.getInfoCompRetencion().getFechaEmision(), fuente), PADDING_NONE);
            cell.setColspan(1);
            cell.setPaddingBottom(15);
            cell.setPaddingLeft(-20);
            table_datos.addCell(cell);
            ...
            cell = generateCell(new Paragraph(factura.getInfoCompRetencion().getIdentificacionSujetoRetenido(), fuente), PADDING_NONE);
            cell.setColspan(5);
            cell.setPaddingBottom(5);
            cell.setPaddingLeft(-20);
            table_datos.addCell(cell);
            ...
            cell = new PdfPCell(new Phrase("Comprobante", title));
            cell.setPaddingBottom(10);
            table_detalle.addCell(cell);

            cell = new PdfPCell(new Phrase("Número", title));
            //cell.setColspan(1);
            table_detalle.addCell(cell);

            cell = new PdfPCell(new Phrase("Fecha Emisión", title));
            cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
            table_detalle.addCell(cell);

            cell = new PdfPCell(new Phrase("Ejercicio Fiscal", title));
            cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
            table_detalle.addCell(cell);

            cell = new PdfPCell(new Phrase("Base Imponible para la Retencion", title));
            cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
            table_detalle.addCell(cell);
            ...
            cell = new PdfPCell(new Phrase("Valor Retenido", title));
            cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
            table_detalle.addCell(cell);
            ...
            for (DocSustento det : lista1) {
                ...
                cell = new PdfPCell(new Phrase(det.getNumDocSustento(), fuente));
                //cell.setColspan(2);
                table_detalle.addCell(cell);

                cell = new PdfPCell(new Phrase(det.getFechaEmisionDocSustento(), fuente));
                cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
                table_detalle.addCell(cell);
                ...
                List<Retencion> listaRetencion = det.getRetencion();
                for (Retencion listaRetencion1 : listaRetencion) {

                    cell = new PdfPCell(new Phrase(listaRetencion1.getBaseImponible(), fuente));
                    cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
                    table_detalle.addCell(cell);
                    ...
                    cell = new PdfPCell(new Phrase(listaRetencion1.getValorRetenido(), fuente));
                    cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
                    table_detalle.setSpacingAfter(10);
                    table_detalle.addCell(cell);
