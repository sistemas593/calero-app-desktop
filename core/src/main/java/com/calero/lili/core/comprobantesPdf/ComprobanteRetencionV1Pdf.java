...
public class ComprobanteRetencionV1Pdf {
    ...
    public void generarPdf(ComprobanteRetencion factura, String AutorizacionSRI, String fechaAutorizacion, byte[] imageBytes) {
        ...
        try {
            ...
            cell = generateCell(new Paragraph("", fuente), LEFT_PADDING_EMPRESA);
            cell.setColspan(2);
            cell.setPaddingTop(20);
            table_datos_empresa.addCell(cell);
            ...
            cell = generateCell(new Paragraph("factura.getInfoCompRetencion().getRazonSocialComprador(),", fuente), PADDING_NONE);
            cell.setColspan(5);
            cell.setPaddingBottom(5);
            ...
            cell = generateCell(new Paragraph("factura.getInfoCompRetencion().getIdentificacionComprador(),", fuente), PADDING_NONE);
            cell.setColspan(1);
            cell.setPaddingBottom(5);
            cell.setPaddingLeft(-20);
            table_datos.addCell(cell);
            ...
            cell = generateCell(new Paragraph("factura.getInfoCompRetencion().getGuiaRemision(),", fuente), PADDING_NONE);
            cell.setColspan(1);
            cell.setPaddingBottom(15);
            cell.setPaddingLeft(-20);
            table_datos.addCell(cell);
 ...
 */
            ...
            /*
            List<Pago> lstFormasPago = factura.getInfoCompRetencion().getPago();
