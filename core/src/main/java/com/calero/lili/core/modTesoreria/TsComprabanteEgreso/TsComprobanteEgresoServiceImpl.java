package com.calero.lili.core.modTesoreria.TsComprabanteEgreso;
...
import com.calero.lili.core.modTesoreria.TsComprabanteEgreso.builder.TsComprobanteEgresoBuilder;
import com.calero.lili.core.modTesoreria.TsComprabanteEgreso.dto.RequestComprobantesEgresoDto;
import com.calero.lili.core.modTesoreria.TsComprabanteEgreso.dto.ResponseComprobantesEgresoDto;
...
public class TsComprobanteEgresoServiceImpl {
    ...
    public void delete(Long idData, Long idEmpresa, UUID idComprobante, String usuario) {
        CnAsientosEntity existeComprobante = cnAsientosRepository.findByIdEntity(idData, idEmpresa, idComprobante, null, null)
                .orElseThrow(() -> new GeneralException(MessageFormat.format("El comprobante no existe: {0}",
                        idComprobante)));
    ...
    public ResponseComprobantesEgresoDto findById(Long idData, Long idEmpresa, UUID idComprobante) {
        return tsComprobanteEgresoBuilder.builderResponse(cnAsientosRepository.findByIdEntity(idData, idEmpresa, idComprobante, null, null)
                .orElseThrow(() -> new GeneralException(MessageFormat.format("El comprobante no existe: {0}",
                        idComprobante))));
    }
    ...
    public void generateComprobanteEgresoPdf(Long idData, Long idEmpresa,
        ...
        CnAsientosEntity comprobante = cnAsientosRepository
                .findByIdEntity(idData, idEmpresa, idComprobanteEgreso, null, null)
